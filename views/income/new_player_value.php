            ...
            <div id="tabcontent4">
                ...
                <div class="layui-tab tabs">
                    ...
                    <div class="containers" id="tabcharcont4">
                        ...
                        <div class="containerItem" id="list4-container4" style="width: 100%;height:300px;"></div>
                        <div class="containerItem" id="list4-container5" style="width: 100%;height:300px;"></div>
                    </div>
                </div>
                <!--表-->
                <div class="layui-tab tabs tabs2" >
...
<script>
    layui.use(['table','layer','laydate'],function () {
        ...
        var list1Chart5 = echarts.init(document.getElementById('list1-container5'));
        ...
        function charTabLine(tabchar1,char1,char2,char3,char4,char5,list3Container1,list3Container2,list3Container3,list3Container4,list3Container5){
            ...
            var listContainer5 = document.getElementById(list3Container5);
            lis1.click(function () {
                $(listContainer5).hide();
                $(listContainer4).hide();
                $(listContainer2).hide();
            ...
            lis5.click(function () {
                ...
                $(listContainer1).hide();
                $(listContainer5).show();
                mychart2('/test/t201',char5);
            });
        }
        function charTabBar(tabchar1,char1,char2,char3,char4,char5,list3Container1,list3Container2,list3Container3,list3Container4,list3Container5){
            var tabchar = document.getElementById(tabchar1);
            var lis1 =$(tabchar).find('li:first');
            var lis2 =$(tabchar).find('li:eq(1)');
            var lis3 =$(tabchar).find('li:eq(2)');
        ...
        function charTabCaky(tabchar1,char1,char2,char3,char4,char5,list3Container1,list3Container2,list3Container3,list3Container4,list3Container5){
            var tabchar = document.getElementById(tabchar1);
            var lis1 =$(tabchar).find('li:first');
            var lis2 =$(tabchar).find('li:eq(1)');
            var lis3 =$(tabchar).find('li:eq(2)');
            ...
            lis5.click(function () {
                ...
                $(listContainer1).hide();
                $(listContainer5).show();
                caky('/test/t201',char5);
            });
        }
        charTabLine('tabchar1',list1Chart1,list1Chart2,list1Chart3,list1Chart4,list1Chart5,'list1-container1','list1-container2','list1-container3','list1-container4','list1-container5');
        charTabBar('tabchar3',list3Chart1,list3Chart2,list3Chart3,list3Chart4,list3Chart5,'list3-container1','list3-container2','list3-container3','list3-container4','list3-container5');
        charTabBar('tabchar4',list4Chart1,list4Chart2,list4Chart3,list4Chart4,list4Chart5,'list4-container1','list4-container2','list4-container3','list4-container4','list4-container5');
        charTabCaky('tabchar5',list5Chart1,list5Chart2,list5Chart3,list5Chart4,list5Chart5,'list5-container1','list5-container2','list5-container3','list5-container4','list5-container5');
        charTabBar('tabchar6',list6Chart1,list6Chart2,list6Chart3,list6Chart4,list6Chart5,'list6-container1','list6-container2','list6-container3','list6-container4','list6-container5');
        ...
        tableRender('list1-table4','/test/t204','age','日期','num','日付费率（%）')
        tableRender('list1-table5','/test/t204','age','日期','num','日付费率（%）')
        ...
        tableRender('list3-table4','/test/t204','age','地区','num','日均ARPPU（￥）')
        tableRender('list3-table5','/test/t204','age','地区','num','日均ARPPU（￥）')
        ...
        tableRender('list4-table4','/test/t204','age','渠道','num','日均付费率（%）')
        tableRender('list4-table5','/test/t204','age','渠道','num','日均付费率（%）')
        ...
        tableRender('list5-table4','/test/t204','age','性别','num','百分比')
        tableRender('list5-table5','/test/t204','age','性别','num','百分比')
        ...
        tableRender('list6-table4','/test/t204','age','年龄','num','日均付费率3（%）')
        tableRender('list6-table5','/test/t204','age','年龄','num','日均付费率3（%）')
