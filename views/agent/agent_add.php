        ...
        <form action=""   style="width: 100%;">
            ...
            <div class="layui-form-item " >
                ...
                <div class="layui-input-inline " style="width: 80%;" >
                    <input id="userId" type="text" class="layui-input layui-form-danger" lay-verify="required|number" name="userID">
                </div>
            </div>
            <!--代理级别-->
            <div class="layui-form-item">
                <label for="" class="layui-form-label">代理级别</label>
                <div class="layui-input-inline" style="width: 80%;">
                    <select name="agentLevel" id="agentLevel" class="layui-select" lay-verify="required" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 80%;">
                    <input id="userName" type="text" class="layui-input" name="name" lay-verify="required">
                </div>
            </div>
            <!--联系方式-->
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 80%;">
                    <input id="Tel" type="text" class="layui-input" name="tel" lay-verify="required|phone">
                </div>
            </div>
            <!--地址-->
            <div class="info layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 33%;">
                    <input id="deatiledAddress" type="text" class="layui-input" placeholder="请输入详细地址">
                </div>
                <div id="show"></div>
            </div>
            <!--提交-->
            <div class="layui-form-item">
                <div class="layui-input-inline layui-col-xs2 layui-col-xs-offset5" >
                    <div class="layui-btn " lay-submit="" lay-filter="create" >创建</div>
...
<script>
    layui.use(['form', 'layedit'], function(){
        ...
        form.on('submit(create)', function(){
            ...
            if(!agentId || !trueName || !province){
                alert('带*号为必填项！');return;
            }
            $.ajax({
                url:"/agent/agent-add"
                ,method:'post'
                ,data:{
                    ...
                    ,'city':$("#s_city").val()
                    ,'county':$("#s_county").val()
                    ,'deatiledAddress':$("#deatiledAddress").val()
                }
