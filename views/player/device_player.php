    ...
    <div class="itemPare">
        <div class="item" >
            ...
            <div id="tabcontent3">
                ...
                <div class="containers" style="display: none">
                    <div class="containerItem"  style="">
                        <table class="layui-table" id="activePlayer3"></table>
                    </div>
                </div>
            </div>
            <div class="tabIcons">
        ...
        <div class="item" >
            ...
            <div id="tabcontent4">
                ...
                <div class="containers" style="display: none">
                    <div class="containerItem"  style="">
                        <table class="layui-table" id="activePlayer4"></table>
                    </div>
                </div>
            </div>
            <div class="tabIcons">
...
<script>
    layui.use(['table','layer','laydate'],function () {
        ...
        mychart3('/test/t201',myChart1);
        mychart4('/test/t201',myChart4);
        mychart4('/test/t201',myChart3);
