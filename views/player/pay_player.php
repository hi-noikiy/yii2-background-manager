...
<div class="x-body">
            ...
            <div class="layui-tab tabs tabs2" >
                ...
                <div class="list1Icon" >
                    <div class="containers" id="tabtablecont1">
                        ...
                        <div class="containerItem"  style="display:none">
                            <table class="layui-table" id="MAU"></table>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="item list1" >
        ...
        <div id="tabcontent4">
            <!--图-->
            <div class="layui-tab tabs">
                <ul class="layui-tab-title " id="tabchar41" >
                    <li class="layui-this">新增付费玩家</li>
                    <li>累计付费玩家</li>
                    <li>总体付费率</li>
                </ul>
                <div class="containers" id="tabcharcont4">
                    <div class="containerItem" id="containe4" style="width: 100%;height:300px;"></div>
                    <div class="containerItem" id="containe5" style="width: 100%;height:300px;"></div>
                    <div class="containerItem" id="containe6" style="width: 100%;height:300px;"></div>
                </div>
            </div>
            <!--表-->
            <div class="layui-tab tabs tabs2" >
                ...
                <div class="list1Icon" >
                    <div class="containers" id="tabtablecont4">
                        <div class="containerItem"  style="">
                            <table class="layui-table" id="DCU4"></table>
                        </div>
                        <div class="containerItem"  style="display:none">
                            <table class="layui-table" id="WAU4"></table>
                        </div>
                        <div class="containerItem"  style="display:none">
                            <table class="layui-table" id="MAU4"></table>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    layui.use(['table','layer','laydate'],function () {
        ...
        var myChar4 = echarts.init(document.getElementById('containe4'));
        var myChar5 = echarts.init(document.getElementById('containe5'));
        var myChar6 = echarts.init(document.getElementById('containe6'));
        ...
        transverse('/test/t201',myChart5);
        transverse('/test/t201',myChart6);
        bar('/test/t201',myChar4);
        ...
        $("#tabchar4 li:first").click(function () {
            $('#container2').hide();
            $('#container3').hide();
            $('#container4').hide();
            $('#container1').show();
        ...
        $("#tabchar4 li:eq(1)").click(function () {
            $('#container3').hide();
            $('#container4').hide();
            $('#container1').hide();
            $('#container2').show();
            bar('/test/t201',myChar5);
        });
        $("#tabchar4 li:eq(2)").click(function () {
            $('#container4').hide();
            $('#container2').hide();
            $('#container1').hide();
            $('#container3').show();
            bar('/test/t201',myChar6);
        });
