...
<script>
 layui.use(['table','form','laydate','element'],function () {
    ...
    //表格数据渲染
     table.render({
         elem:"#player"
         ,url:"/wechat-web/get-take-money-order"
         ,page:true
         ,size: 'lg'
         ,cols:[[
         ...
         ,done:function (res, curr, count) {
             ...
             $('#payTotal').html(0);
             $.ajax({
                 url:"/wechat-web/get-take-money-time-order"
                 ,data:{
