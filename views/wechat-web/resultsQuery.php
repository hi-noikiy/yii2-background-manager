    ...
    layui.use(['table', 'form', 'laydate'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: "rebate", title: '业绩(元)', align: 'center'}
                , {field: "", title: "操作", toolbar: "#myAgentDetail", align: 'center'}
            ]]
        });
        //日查详情监听
...
//            , page: true
            ...
            , cols: [[
                {field: "rebate_week", title: '日期', align: 'center', width: '40%'}
                , {field: "consume", title: '业绩(元)', align: 'center', width: '30%'}
                , {field: "rebate", title: '收益(元)', align: 'center', width: '30%', minWidth: 100}
//                , {field: "", title: "操作", toolbar: "#myAgentWeekDetail", align: 'center', width: '20%', minWidth: 100}
            ]]
        });
        //周查详情监听
...
//                        , page: true
        ...
        var active = {
            search1: function () {
                ...
                if (type == 1) {
                    thisTable = 'myAgent';
                    thisUrl = '/wechat-web/results-day';
                } else {
                    thisTable = 'myAgentWeek';
                    thisUrl = '/wechat-web/results-week';
                }
                reloadIframeWeb('resultsInfo');
...
//                    },
            ...
            detail1: function () {
                ...
                if (type == 1) {
                    thisUrl = '/wechat-web/day-details';
                    ...
                    thisUrl = '/wechat-web/week-details';
                    var layID = $(".layui-tab-title .layui-this").attr("lay-id");
                    if (layID == 'withdrawCash') {
