...
return [
    ...
    'wechat_config' => [
        'API_KEY' => '7293edb63c09a81dbc6b2f6e3aacd9fc-111',//直兑api秘钥
    ...
    'exchange_white_list'=>['30444308','50773780','50820923'],
    ...
    'exchange_config'=>[
        ...
        'bank_hfb'=>[
            ...
            'notify_url'=>'https://pay-t.game0165.com/api/notify/exchange-notify',
...
//        '1114112'=>"大厅"
    ...
    //充值地址
    'recharge_Url' => 'http://127.0.0.1:9966/recharge',
    ...
    //kicking_url封停账号
    'kicking_url' => 'http://127.0.0.1:9966/player_downline?',
    //跑马灯
    'pm_url' => 'http://127.0.0.1:9966/paomadeng',
    //公告邮件
    'email_url' => 'http://127.0.0.1:9966/mail',
    //天降红包
    'sky_drop_hongbao_url' => 'http://127.0.0.1:9966/hongbao',
    //百人场踢出房间
...
//            262407 => 'rule',
    ...
    //解散房间
    'dissolveTable'=>[
        '524817' =>'http://127.0.0.1:19935/forceDismissTable',//填大坑
        '524818' =>'http://127.0.0.1:20021/forceDismissTable',//新牛牛
        '524815' =>'http://127.0.0.1:19934/forceDismissTable',//新推筒子
        '524816' =>'http://127.0.0.1:19938/forceDismissTable',//新扎金花
        '524822' =>'http://127.0.0.1:19947/forceDismissTable',//斗地主
    ],
    //查询牌桌信息
    'checkTableInfo'=>[
        '524817' => [//填大坑(格式不能变)
            'url'=>'http://127.0.0.1:19935/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ['黑桃', '红桃', '梅花', '方片','王'],
                'king'  => ['小','大'],
        ...
        '524818' => [//新牛牛(格式不能变)
            'url'=>'http://127.0.0.1:20021/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
        ...
        '524816' => [//新扎金花(格式不能变)
            'url'=>'http://127.0.0.1:19938/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
        ...
        '524815' => [//新牛牛(格式不能变)
            'url'=>'http://127.0.0.1:19934/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
        ...
        '524822' => [//斗地主(格式不能变)
            'url'=>'http://127.0.0.1:19947/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
