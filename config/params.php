...
return [
    ...
    'change_bind_modile' => '18736399277',//改绑手机号
    'channel_rule_name' => '渠道',//平台登陆账号角色 渠道合伙人的角色名称
    ...
    'wechat_web_black_list'=>[30001417,30006534,30039877,30047704,30048140,30048960,30060619,30071428,30073965,30075452,30077614,30084067,30103752,30104949,30115788,30124376,30124741,30149832,30151069,30162614,30173979,30178941,30182120,30207921,30209054,30213278,30232411,30233882,30234602,30246036,30262158,30285989,30287425,30291115,30291338,30301279,30301355,30303346,30312528,30315923,30320772,30330012,30350793,30355756,30358594,30361528,30381268,30402393,30410542,30410976,30414372,30418494,30435321,30440952,30444082,30450552,30484116,30489101,30492209,30492858,30499694,30503341,30508848,30509239,30510936,30511186,30538184,30547795,30549342,30554314,30569227,30579075,30583502,30584215,30591127,30598021,30612278,30613828,30646517,30653224,30658532,30659938,30662393,30663056,30670964,30676567,30682389,30687281,30689867,30701524,30712286,30713128,30729366,30760375,30773244,30778364,30778712,30779385,30785534,30795203,30807594,30831773,30834066,30836386,30836587,30841499,30842533,30846826,30849854,30870852,30872280,30874011,30875881,30887478,30892723,30896731,30897772,30959805,30961363,30965475,30981893,30988291,30997053,30498486,30037866],
    ...
    /** 直兑白名单 */
    'exchange_white_list_switch'=>2,//1打开 2关闭
    'exchange_white_list'=>['30444308','30686795'],
    ...
    'bind_condition'=>[
        ...
        'bank'=>[
            'is_use'=>0,//是否启用 1启用
            'over_all_line'=>2000000,
            'up_line'=>2000000,//直兑上线
            'down_line'=>10000,//直兑下线
            'minimum_reserve'=>1000,//直兑最低保留
    ...
    'exchange_config'=>[
        ...
        'bank_hfb'=>[
            ...
            'notify_url'=>'https://pay.game0165.com/api/notify/exchange-notify',
...
//        '1114112'=>"大厅"
    ...
    //充值地址
    'recharge_Url' => 'http://10.0.4.132:9966/recharge',
    ...
    //kicking_url封停账号
    'kicking_url' => 'http://10.0.4.132:9966/player_downline?',
    //跑马灯
    'pm_url' => 'http://10.0.4.132:9966/paomadeng',
    //公告邮件
    'email_url' => 'http://10.0.4.132:9966/mail',
    //红包
    'sky_drop_hongbao_url' => 'http://10.0.4.132:9966/hongbao',
    //百人场踢出房间
    'hundreds_kick' => 'http://10.0.4.132:20033',
    //百人场游戏列表
    'hundreds_games' => [
        524821,//百人推筒子
        524823,//百人牛牛
    ...
    'wechat_web_rebate_back_list'=>['30130224','30444308'],
...
//            262407 => 'rule',
    ...
    //解散房间
    'dissolveTable'=>[
        '524817' =>'http://10.0.4.131:19935/forceDismissTable',//填大坑
        '524818' =>'http://10.0.4.131:20021/forceDismissTable',//新牛牛
        '524815' =>'http://10.0.4.131:19934/forceDismissTable',//新推筒子
        '524816' =>'http://10.0.4.131:19938/forceDismissTable',//新扎金花
        '524822' =>'http://10.0.4.131:19947/forceDismissTable',//斗地主
    ],
    //查询牌桌信息
    'checkTableInfo'=>[
        '524817' => [//填大坑(格式不能变)
            'url'=>'http://10.0.4.131:19935/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ['黑桃', '红桃', '梅花', '方片','王'],
                'king'  => ['小','大'],
        ...
        '524818' => [//新牛牛(格式不能变)
            'url'=>'http://10.0.4.131:20021/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
        ...
        '524815' => [//新牛牛(格式不能变)
            'url'=>'http://10.0.4.131:19934/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
        ...
        '524822' => [//斗地主(格式不能变)
            'url'=>'http://10.0.4.131:19947/tableInformation',
            'cardRule'=>[
                'num' => 13,
                'color' => ["♦", "♣", "♥", "♠", "王"],
                'king'  => ['小','大'],
