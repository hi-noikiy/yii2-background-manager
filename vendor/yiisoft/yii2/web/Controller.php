...
class Controller extends \yii\base\Controller
{
     ...
     *
     * This method is simir to [[renderPartial()]] except that it will inject into
    ...
    public function AjaxReturn($data, $errorCode = 0, $errorMsg = ''){
        ...
        $response = json_encode(array('ret_code' => $errorCode, 'ret_msg' => $errorMsg, 'data' => $data === false ? "" : $data), JSON_UNESCAPED_UNICODE);
