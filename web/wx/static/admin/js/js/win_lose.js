...
var vm =  new Vue({
    ...
    methods:{
        ...
        search : function(){
            ...
            $.ajax({
                type : 'get',
                url : base_url + '&r=admin-oper/get-win-lose',
                data : {
                    page_index : 1 ,
                    page_size : this.pagesize ,
                    sort_key : this.sort_key ,
                    sort_value : this.sort_value,
                    day_start : $("#dateinfo1").val(),
                    day_end : $("#dateinfo2").val(),
                    game_id : $("#game_id").val()
                },
                success: function(res){
                    var json = res;
        ...
        sort_me : function(n){    //排序
            var sort_key = 'stat_date';
            var sort_value = 4;

            if( n == 'dizhu_z' ){                 //id正序
                sort_key = 'dizhu';
                sort_value  =  4;
            }else if( n == 'dizhu_d' ){            //id倒序
                sort_key = 'dizhu';
                sort_value  =  3;
            }else if( n == 'win_count_z' ){            //id倒序
                sort_key = 'win_count';
                sort_value  =  4;
            }else if( n == 'win_count_d' ){            //id倒序
                sort_key = 'win_count';
                sort_value  =  3;
            }else if( n == 'win_z' ){            //id倒序
                sort_key = 'win';
                sort_value  =  4;
            }else if( n == 'win_d' ){            //id倒序
                sort_key = 'win';
                sort_value  =  3;
            }else if( n == 'lose_count_z' ){            //id倒序
                sort_key = 'lose_count';
                sort_value  =  4;
            }else if( n == 'lose_count_d' ){            //id倒序
                sort_key = 'lose_count';
                sort_value  =  3;
            }else if( n == 'lose_z' ){            //id倒序
                sort_key = 'lose';
                sort_value  =  4;
            }else if( n == 'lose_d' ){            //id倒序
                sort_key = 'lose';
                sort_value  =  3;
            }else if( n == 'counter_res_z' ){            //id倒序
                sort_key = 'counter_res';
                sort_value  =  4;
            }else if( n == 'counter_res_d' ){            //id倒序
                sort_key = 'counter_res';
                sort_value  =  3;
            }else if( n == 'rate_win_lose_z' ){            //id倒序
                sort_key = 'rate_win_lose';
                sort_value  =  4;
            }else if( n == 'rate_win_lose_d' ){            //id倒序
                sort_key = 'rate_win_lose';
                sort_value  =  3;
            }
