...
var vm =  new Vue({
    ...
    methods:{
        ...
        search : function(){
            ...
            $.ajax({
                type : 'get',
                url : base_url + '&r=admin-oper/get-partner-active',
                data : {
                    page_index : 1 ,
...
//                        day_end : $("#dateinfo2").val(),
        ...
        sort_me : function(n){    //排序
            ...
            if( n == 'gold_z' ){                 //id正序
                sort_key = 'current_gold';
                sort_value  =  4;
            }else if( n == 'gold_d' ){            //id倒序
                sort_key = 'current_gold';
                sort_value  =  3;
            }else if( n == 'consume_z' ){            //id倒序
                sort_key = 'consume';
                sort_value  =  4;
            }else if( n == 'consume_d' ){            //id倒序
                sort_key = 'consume';
                sort_value  =  3;
            }else if( n == 'recharge_z' ){            //id倒序
                sort_key = 'recharge';
                sort_value  =  4;
            }else if( n == 'recharge_d' ){            //id倒序
                sort_key = 'recharge';
                sort_value  =  3;
            }else if( n == 'regist_z' ){            //id倒序
                sort_key = 'regist_time';
                sort_value  =  4;
            }else if( n == 'regist_d' ){            //id倒序
                sort_key = 'regist_time';
                sort_value  =  3;
            }else if( n == 'last_login_z' ){            //id倒序
                sort_key = 'last_login';
                sort_value  =  4;
            }else if( n == 'last_login_d' ){            //id倒序
                sort_key = 'last_login';
                sort_value  =  3;
            }else if( n == 'parent_id_z' ){            //id倒序
                sort_key = 'parent_name';
                sort_value  =  4;
            }else if( n == 'parent_id_d' ){            //id倒序
                sort_key = 'parent_name';
                sort_value  =  3;
            }
